...
class HomePage extends Component with HasGameReference<RacingGame> {
  HomePage() {
    addAll([
      _logo = TextComponent(
        text: 'Rival Racing',
      ...
      _button1 = RoundedButton(
        ...
        action: () => game.router.pushNamed('map-selector'),
...
class BackButton extends SimpleButton with HasGameReference<RacingGame> {
  BackButton()
      : super(
          Path()
            ..moveTo(22, 8)
...
class PauseButton extends SimpleButton with HasGameReference<RacingGame> {
  PauseButton()
      : super(
          Path()
            ..moveTo(14, 10)
...
class PausePage extends Component
    with TapCallbacks, HasGameReference<RacingGame> {
  @override
  Future<void> onLoad() async {
    final game = findGame()!;
    addAll([
